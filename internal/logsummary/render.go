...
var bucketPhrasing = map[string]phrasing{
	...
	"list_files":    {"Listed Go files %d time", "Listed Go files %d times"},
...
var messageBucket = map[string]string{
	...
	"lint find go files for gocyclo":                "list_files",
	"lint list module go files for fmt":             "list_files",
	"lint list staged go files":                     "list_files",
	"lint list packages for nested worktree filter": "list_files",
