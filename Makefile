...
GO_MK := go.mk
GO_MK_VERSION_PKG := goodkind.io/go-makefile/internal/version
GO_MK_RELEASE_BINS := go-mk:./cmd/go-mk go-mk-install:./cmd/go-mk-install
GO_MK_INSTALL_BINS := $(GO_MK_RELEASE_BINS)
