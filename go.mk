...
# __go_mk_prime downloads the go-makefile archive once and copies only the helper
...
# awk body lives under scripts/. Fetch order: dev override > files __go_mk_prime
...
# __go_mk_prime already copied each script from the tarball, so require it when
...
__GO_MK_ENGINE := $(if $(strip $(GO_MK_BIN)),$(GO_MK_BIN),$(CURDIR)/.make/go-mk)
...
go-mk-notice: go-mk-bin
	@"$(__GO_MK_ENGINE)" notice || true

lint-tools: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-tools

lint-golangci: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-golangci

lint-format: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-format

lint-gocyclo: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-gocyclo

lint-gocyclo-baseline: go-mk-bin
	@BASELINE_UPDATE_MODE=sync "$(__GO_MK_ENGINE)" baseline gocyclo

lint-gocyclo-baseline-prune-fixed: go-mk-bin
	@BASELINE_UPDATE_MODE=prune-fixed "$(__GO_MK_ENGINE)" baseline gocyclo

lint-gocyclo-baseline-remove-fixed: lint-gocyclo-baseline-prune-fixed

lint-gocyclo-baseline-accept-new: go-mk-bin
	@BASELINE_UPDATE_MODE=accept-new "$(__GO_MK_ENGINE)" baseline gocyclo

lint-files: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-files

lint-diff: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-diff
...
go-version-check: go-mk-bin
	@"$(__GO_MK_ENGINE)" go-version-check
...
ci-changed: go-mk-bin
	@"$(__GO_MK_ENGINE)" ci-changed

go-mk-cache-manifest: go-mk-bin
	@"$(__GO_MK_ENGINE)" cache-manifest
...
go-mk-prepare-submodules: go-mk-bin
	@"$(__GO_MK_ENGINE)" prepare-generated-submodules

lint-deadcode: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-deadcode

baseline-bin go-mk-bin:
	@bash "$(_GO_MK_HELPER_DIR)/go-mk-bin.sh" bin

staticcheck-extra-bin: go-mk-bin
	@"$(__GO_MK_ENGINE)" staticcheck-extra-bin

staticcheck-extra: go-mk-bin
	@"$(__GO_MK_ENGINE)" staticcheck-extra

lint-golangci-baseline: go-mk-bin
	@BASELINE_UPDATE_MODE=sync "$(__GO_MK_ENGINE)" baseline golangci

lint-golangci-baseline-prune-fixed: go-mk-bin
	@BASELINE_UPDATE_MODE=prune-fixed "$(__GO_MK_ENGINE)" baseline golangci

lint-golangci-baseline-remove-fixed: lint-golangci-baseline-prune-fixed

lint-golangci-baseline-accept-new: go-mk-bin
	@BASELINE_UPDATE_MODE=accept-new "$(__GO_MK_ENGINE)" baseline golangci

lint-golangci-scope: go-mk-bin
	@"$(__GO_MK_ENGINE)" lint-golangci-scope

lint-golangci-baseline-scope: go-mk-bin
	@BASELINE_UPDATE_MODE=sync "$(__GO_MK_ENGINE)" baseline golangci-scope

lint-golangci-baseline-scope-accept-new: go-mk-bin
	@BASELINE_UPDATE_MODE=accept-new "$(__GO_MK_ENGINE)" baseline golangci-scope

lint-deadcode-baseline: go-mk-bin
	@BASELINE_UPDATE_MODE=sync "$(__GO_MK_ENGINE)" baseline deadcode

lint-deadcode-baseline-prune-fixed: go-mk-bin
	@BASELINE_UPDATE_MODE=prune-fixed "$(__GO_MK_ENGINE)" baseline deadcode

lint-deadcode-baseline-remove-fixed: lint-deadcode-baseline-prune-fixed

lint-deadcode-baseline-accept-new: go-mk-bin
	@BASELINE_UPDATE_MODE=accept-new "$(__GO_MK_ENGINE)" baseline deadcode

staticcheck-extra-baseline: go-mk-bin
	@BASELINE_UPDATE_MODE=sync "$(__GO_MK_ENGINE)" baseline staticcheck-extra

staticcheck-extra-baseline-prune-fixed: go-mk-bin
	@BASELINE_UPDATE_MODE=prune-fixed "$(__GO_MK_ENGINE)" baseline staticcheck-extra
...
staticcheck-extra-baseline-accept-new: go-mk-bin
	@BASELINE_UPDATE_MODE=accept-new "$(__GO_MK_ENGINE)" baseline staticcheck-extra

build-check: go-mk-bin
	@"$(__GO_MK_ENGINE)" build-check
...
baseline: go-mk-bin
	@BASELINE_UPDATE_MODE=sync "$(__GO_MK_ENGINE)" baseline all

baseline-prune-fixed: go-mk-bin
	@BASELINE_UPDATE_MODE=prune-fixed "$(__GO_MK_ENGINE)" baseline all

baseline-remove-fixed: baseline-prune-fixed

baseline-accept-new: go-mk-bin
	@BASELINE_UPDATE_MODE=accept-new "$(__GO_MK_ENGINE)" baseline all
...
# GO_MK_GENERATE_OUTPUTS: optional repo-relative generated paths that the
# reusable GitHub workflows may restore and save. These paths are the cache
# payload only; they are not freshness inputs. Use only ignored generated files,
# not tracked sources that checkout already owns.
